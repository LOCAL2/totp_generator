...
(function(L, P) {
    typeof exports == "object" && typeof module != "undefined" ? P(exports) : typeof define == "function" && define.amd ? define(["exports"], P) : (L = typeof globalThis != "undefined" ? globalThis : L || self,
    P(L.OTPAuth = {}))
}
)(this, function(L) {
    "use strict";
        ...
        case "TEXT":
            return function(t, r, s) {
                return function(u, c, a, l, w) {
                    let f, h, g, m, p, A, b, C, I = 0;
                    const H = a || [0]
                      , S = (l = l || 0) >>> 3;
                    if (c === "UTF8")
                        for (b = w === -1 ? 3 : 0,
                        g = 0; g < u.length; g += 1)
                            for (f = u.charCodeAt(g),
                            h = [],
                            128 > f ? h.push(f) : 2048 > f ? (h.push(192 | f >>> 6),
                            h.push(128 | 63 & f)) : 55296 > f || 57344 <= f ? h.push(224 | f >>> 12, 128 | f >>> 6 & 63, 128 | 63 & f) : (g += 1,
                            f = 65536 + ((1023 & f) << 10 | 1023 & u.charCodeAt(g)),
                            h.push(240 | f >>> 18, 128 | f >>> 12 & 63, 128 | f >>> 6 & 63, 128 | 63 & f)),
                            m = 0; m < h.length; m += 1) {
                                for (A = I + S,
                                p = A >>> 2; H.length <= p; )
                                    H.push(0);
            ...
            return function(t, r, s) {
                return function(u, c, a, l) {
                    ...
                    for (f = 0; f < u.length; f += 4) {
                        ...
                        g = 0,
                        h = 0; h < m.length; h += 1)
                            w = W.indexOf(m.charAt(h)),
                            g |= w << 18 - 6 * h;
                        for (h = 0; h < m.length - 1; h += 1) {
                            for (A = b + I,
                            p = A >>> 2; C.length <= p; )
                                C.push(0);
                            C[p] |= (g >>> 16 - 8 * h & 255) << 8 * (H + l * (A % 4)),
                            b += 1
                        }
                    }
                    return {
            ...
            return function(r) {
                return function(s, u, c, a) {
                    ...
                    const p = u / 8
                      , A = c === -1 ? 3 : 0;
                    for (l = 0; l < p; l += 3)
                        for (h = l + 1 < p ? s[l + 1 >>> 2] : 0,
                        g = l + 2 < p ? s[l + 2 >>> 2] : 0,
                        f = (s[l >>> 2] >>> 8 * (A + c * (l % 4)) & 255) << 16 | (h >>> 8 * (A + c * ((l + 1) % 4)) & 255) << 8 | g >>> 8 * (A + c * ((l + 2) % 4)) & 255,
                        w = 0; w < 4; w += 1)
                            m += 8 * l + 6 * w <= u ? W.charAt(f >>> 6 * (3 - w) & 63) : a.b64Pad;
                    return m
                }(r, e, n, t)
            }
            ;
    ...
    function z(i, e) {
        ...
        if (r % 4 != 0) {
            ...
            return (i.value.length << 2) - 4 >= s + r && i.value.pop(),
            {
                value: i.value,
                binLen: i.binLen + e.binLen
            }
        }
        return {
            value: i.value.concat(e.value),
            binLen: i.binLen + e.binLen
        }
    }
    function te(i) {
    ...
    let D = class {
        ...
        update(e) {
            ...
            const r = this.m >>> 5
              ...
              , a = u >>> 5;
            for (n = 0; n < a; n += r)
                t + this.m <= u && (this.R = this.U(c.slice(n, n + r), this.R),
                t += this.m);
            return this.A += t,
            this.h = c.slice(t >>> 5),
            this.u = u % this.m,
        ...
        getHash(e, n) {
            ...
            if (this.H && this.F)
                return c(this.F(u));
            for (r = this.g(this.h.slice(), this.u, this.A, this.B(this.R), s),
            t = 1; t < this.numRounds; t += 1)
                this.K && s % 32 != 0 && (r[r.length - 1] &= 16777215 >>> 24 - s % 32),
        ...
        Y() {
            ...
            return e = this.U(this.p, this.L(this.o)),
    ...
    function be(i, e, n, t) {
        ...
        return (65535 & (i >>> 16) + (e >>> 16) + (n >>> 16) + (t >>> 16) + (r >>> 16)) << 16 | 65535 & r
    }
    function Y(i, e, n, t, r) {
        const s = (65535 & i) + (65535 & e) + (65535 & n) + (65535 & t) + (65535 & r);
        return (65535 & (i >>> 16) + (e >>> 16) + (n >>> 16) + (t >>> 16) + (r >>> 16) + (s >>> 16)) << 16 | 65535 & s
    }
    function Ie(i) {
    ...
    function oe(i, e) {
        ...
        u = e[4],
        a = 0; a < 80; a += 1)
            l[a] = a < 16 ? i[a] : M(l[a - 3] ^ l[a - 8] ^ l[a - 14] ^ l[a - 16], 1),
            c = a < 20 ? Y(M(n, 5), ie(t, r, s), u, 1518500249, l[a]) : a < 40 ? Y(M(n, 5), re(t, r, s), u, 1859775393, l[a]) : a < 60 ? Y(M(n, 5), se(t, r, s), u, 2400959708, l[a]) : Y(M(n, 5), re(t, r, s), u, 3395469782, l[a]),
            u = s,
            s = r,
            r = M(t, 30),
            t = n,
    ...
    function ue(i) {
        let e;
        return e = i == "SHA-224" ? $.slice() : B.slice(),
        e
    }
    function he(i, e) {
        ...
        l = e[7],
        h = 0; h < 64; h += 1)
            g[h] = h < 16 ? i[h] : be(R(m = g[h - 2], 17) ^ R(m, 19) ^ ne(m, 10), g[h - 7], Ie(g[h - 15]), g[h - 16]),
        ...
        constructor(e, n, t) {
            ...
            this.g = function(s, u, c, a) {
                return function(l, w, f, h, g) {
                    ...
                    for (; l.length <= A; )
                        l.push(0);
                    for (l[w >>> 5] |= 128 << 24 - w % 32,
                    l[A] = 4294967295 & b,
                    l[A - 1] = b / 4294967296 | 0,
                    m = 0; m < l.length; m += 16)
                        h = he(l.slice(m, m + 16), h);
                    return p = g === "SHA-224" ? [h[0], h[1], h[2], h[3], h[4], h[5], h[6]] : h,
                    p
                }(s, u, c, a, e)
            }
            ,
    ...
    function ae(i, e) {
        let n;
        return e > 32 ? (n = 64 - e,
        new o(i.I << e | i.N >>> n,i.N << e | i.I >>> n)) : e !== 0 ? (n = 32 - e,
        new o(i.N << e | i.I >>> n,i.I << e | i.N >>> n)) : i
    }
    function T(i, e) {
        let n;
        return e < 32 ? (n = 32 - e,
        new o(i.N >>> e | i.I << n,i.I >>> e | i.N << n)) : (n = 64 - e,
    ...
    function Se(i, e, n) {
        return new o(i.N & e.N ^ i.N & n.N ^ e.N & n.N,i.I & e.I ^ i.I & n.I ^ e.I & n.I)
    }
    function Re(i) {
        const e = T(i, 28)
          , n = T(i, 34)
    ...
    function N(i, e) {
        ...
        return n = (65535 & i.N) + (65535 & e.N) + (t >>> 16),
    ...
    function Te(i, e, n, t) {
        ...
        s = (i.I >>> 16) + (e.I >>> 16) + (n.I >>> 16) + (t.I >>> 16) + (r >>> 16);
        const u = (65535 & s) << 16 | 65535 & r;
        return r = (65535 & i.N) + (65535 & e.N) + (65535 & n.N) + (65535 & t.N) + (s >>> 16),
        s = (i.N >>> 16) + (e.N >>> 16) + (n.N >>> 16) + (t.N >>> 16) + (r >>> 16),
        new o((65535 & s) << 16 | 65535 & r,u)
    }
    function Ue(i, e, n, t, r) {
        let s, u;
        s = (65535 & i.I) + (65535 & e.I) + (65535 & n.I) + (65535 & t.I) + (65535 & r.I),
        u = (i.I >>> 16) + (e.I >>> 16) + (n.I >>> 16) + (t.I >>> 16) + (r.I >>> 16) + (s >>> 16);
        const c = (65535 & u) << 16 | 65535 & s;
        return s = (65535 & i.N) + (65535 & e.N) + (65535 & n.N) + (65535 & t.N) + (65535 & r.N) + (u >>> 16),
        u = (i.N >>> 16) + (e.N >>> 16) + (n.N >>> 16) + (t.N >>> 16) + (r.N >>> 16) + (s >>> 16),
    ...
    function fe(i, e) {
        ...
        h = 0; h < 80; h += 1)
            h < 16 ? (g = 2 * h,
            m[h] = new o(i[g],i[g + 1])) : m[h] = Te(Ce(m[h - 2]), m[h - 7], Le(m[h - 15]), m[h - 16]),
            w = Ue(l, $e(u), (A = c,
            b = a,
            new o((p = u).N & A.N ^ ~p.N & b.N,p.I & A.I ^ ~p.I & b.I)), Be[h], m[h]),
            f = N(Re(n), Se(n, t, r)),
            l = a,
            a = c,
            c = u,
        ...
        constructor(e, n, t) {
            ...
            this.g = function(s, u, c, a) {
                return function(l, w, f, h, g) {
                    ...
                    return p = g === "SHA-384" ? [h[0].N, h[0].I, h[1].N, h[1].I, h[2].N, h[2].I, h[3].N, h[3].I, h[4].N, h[4].I, h[5].N, h[5].I] : [h[0].N, h[0].I, h[1].N, h[1].I, h[2].N, h[2].I, h[3].N, h[3].I, h[4].N, h[4].I, h[5].N, h[5].I, h[6].N, h[6].I, h[7].N, h[7].I],
                    p
                }(s, u, c, a, e)
            }
            ,
    ...
    const Fe = [new o(0,1), new o(0,32898), new o(2147483648,32906), new o(2147483648,2147516416), new o(0,32907), new o(0,2147483649), new o(2147483648,2147516545), new o(2147483648,32777), new o(0,138), new o(0,136), new o(0,2147516425), new o(0,2147483658), new o(0,2147516555), new o(2147483648,139), new o(2147483648,32905), new o(2147483648,32771), new o(2147483648,32770), new o(2147483648,128), new o(0,32778), new o(2147483648,2147483658), new o(2147483648,2147516545), new o(2147483648,32896), new o(0,2147483649), new o(2147483648,2147516424)]
      , Me = [[0, 36, 3, 41, 18], [1, 44, 10, 45, 2], [62, 6, 43, 15, 61], [28, 55, 25, 21, 56], [27, 20, 39, 8, 14]];
    function V(i) {
        let e;
        const n = [];
        for (e = 0; e < 5; e += 1)
    ...
    function q(i, e) {
        ...
        if (i !== null)
            for (t = 0; t < i.length; t += 2)
                e[(t >>> 1) % 5][(t >>> 1) / 5 | 0] = x(e[(t >>> 1) % 5][(t >>> 1) / 5 | 0], new o(i[t + 1],i[t]));
        for (n = 0; n < 24; n += 1) {
            for (s = V(),
            t = 0; t < 5; t += 1)
                u[t] = (a = e[t][0],
            ...
            for (t = 0; t < 5; t += 1)
                for (r = 0; r < 5; r += 1)
                    e[t][r] = x(s[t][r], new o(~s[(t + 1) % 5][r].N & s[(t + 2) % 5][r].N,~s[(t + 1) % 5][r].I & s[(t + 2) % 5][r].I));
            e[0][0] = x(e[0][0], Fe[n])
        }
        var a, l, w, f, h;
        return e
    ...
    class Pe extends D {
        constructor(e, n, t) {
            ...
            this.g = function(c, a, l, w, f) {
                return function(h, g, m, p, A, b, C) {
                    ...
                    h[I >> 2] ^= b << I % 4 * 8,
                    h[G - 1] ^= 2147483648,
                    p = q(h, p); 32 * j.length < C && (H = p[S % 5][S / 5 | 0],
                    j.push(H.I),
                    !(32 * j.length >= C)); )
                        j.push(H.N),
                        S += 1,
        ...
        O(e, n) {
            const t = function(s) {
                const u = s || {};
                return {
                    funcName: K("funcName", u.funcName, 1, {
                        value: [],
                        binLen: 0
                    }),
    ...
    const k = ( () => {
      ...
      , xe = (i, e, n) => {
        Z != null;
        {
            ...
            return r.setHMACKey(e, "ARRAYBUFFER"),
            r.update(n),
      ...
      , Xe = i => {
        ...
        for (let a = 0; a < n.length; a++) {
            ...
            if (l === -1)
                throw new TypeError(`Invalid character found: ${n[a]}`);
            u = u << 5 | l,
            s += 5,
            s >= 8 && (s -= 8,
            r[c++] = u >>> s)
    ...
    class U {
        constructor() {
            let {buffer: e, size: n=20} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        ...
        get latin1() {
            return Object.defineProperty(this, "latin1", {
                enumerable: !0,
        ...
        get utf8() {
            return Object.defineProperty(this, "utf8", {
                enumerable: !0,
        ...
        get base32() {
            return Object.defineProperty(this, "base32", {
                enumerable: !0,
    ...
    const Qe = (i, e) => {
        Z != null;
        {
            ...
            let n = -1
              , t = 0;
            for (; ++n < i.length; )
                t |= i.charCodeAt(n) ^ e.charCodeAt(n);
            return t === 0
        }
    }
    ;
    ...
    let X = class v {
        ...
        constructor() {
            let {issuer: e=v.defaults.issuer, label: n=v.defaults.label, secret: t=new U, algorithm: r=v.defaults.algorithm, digits: s=v.defaults.digits, counter: u=v.defaults.counter} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            this.issuer = e,
            this.label = n,
        ...
        static generate(e) {
            let {secret: n, algorithm: t=v.defaults.algorithm, digits: r=v.defaults.digits, counter: s=v.defaults.counter} = e;
            const u = new Uint8Array(xe(t, n.buffer, P(s)))
              , c = u[u.byteLength - 1] & 15;
            return (((u[c] & 127) << 24 | (u[c + 1] & 255) << 16 | (u[c + 2] & 255) << 8 | u[c + 3] & 255) % We(10, r)).toString().padStart(r, "0")
        }
        generate() {
            let {counter: e=this.counter++} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return v.generate({
                secret: this.secret,
        ...
        static validate(e) {
            let {token: n, secret: t, algorithm: r, digits: s, counter: u=v.defaults.counter, window: c=v.defaults.window} = e;
            if (n.length !== s)
                return null;
            let a = null;
    ...
    class E {
        ...
        constructor() {
            let {issuer: e=E.defaults.issuer, label: n=E.defaults.label, secret: t=new U, algorithm: r=E.defaults.algorithm, digits: s=E.defaults.digits, period: u=E.defaults.period} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            this.issuer = e,
            this.label = n,
            this.secret = typeof t == "string" ? U.fromBase32(t) : t,
            this.algorithm = r.toUpperCase(),
        ...
        static generate(e) {
            let {secret: n, algorithm: t, digits: r, period: s=E.defaults.period, timestamp: u=Date.now()} = e;
            return X.generate({
                secret: n,
                algorithm: t,
                digits: r,
        ...
        generate() {
            let {timestamp: e=Date.now()} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return E.generate({
                secret: this.secret,
                algorithm: this.algorithm,
                digits: this.digits,
        ...
        static validate(e) {
            let {token: n, secret: t, algorithm: r, digits: s, period: u=E.defaults.period, timestamp: c=Date.now(), window: a} = e;
            return X.validate({
                token: n,
                secret: t,
                algorithm: r,
    ...
    const _e = /^otpauth:\/\/([ht]otp)\/(.+)\?([A-Z0-9.~_-]+=[^?&]*(?:&[A-Z0-9.~_-]+=[^?&]*)*)$/i
      , et = /^[2-7A-Z]+=*$/i
    ...
    class rt {
        static parse(e) {
            ...
            if (t === "hotp")
                if (u = X,
                typeof s.counter != "undefined" && nt.test(s.counter))
                    c.counter = parseInt(s.counter, 10);
                else
                    throw new TypeError("Missing or invalid 'counter' parameter");
            else if (t === "totp") {
                if (u = E,
                typeof s.period != "undefined")
                    if (pe.test(s.period))
                        c.period = parseInt(s.period, 10);
                    else
                        throw new TypeError("Invalid 'period' parameter")
            } else
                throw new TypeError("Unknown OTP type");
            if (r.length === 2 ? (c.label = r[1],
            c.issuer = r[0]) : (c.label = r[0],
            ...
            if (typeof s.algorithm != "undefined")
                if (tt.test(s.algorithm))
                    c.algorithm = s.algorithm;
                else
                    throw new TypeError("Invalid 'algorithm' parameter");
            if (typeof s.digits != "undefined")
                if (pe.test(s.digits))
                    c.digits = parseInt(s.digits, 10);
                else
                    throw new TypeError("Invalid 'digits' parameter");
            return new u(c)
        }
        static stringify(e) {
            if (e instanceof X || e instanceof E)
                return e.toString();
